...
class SystemInfoView(APIView):
    """
    API که اطلاعات کلی سیستم شامل CPU، RAM، دیسک‌ها، شبکه، GPU و باتری را برمی‌گرداند
    """
...
class SystemStatusView(APIView):
    """
    API که وضعیت فعلی سیستم شامل مصرف CPU، حافظه، دیسک، شبکه، GPU و باتری را برمی‌گرداند
    """
